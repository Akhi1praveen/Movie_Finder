...
export const getPopularTv = async (page = 1) => {
  const response = await fetch(`${BASE_URL}/tv/popular?api_key=${API_KEY}&page=${page}&language=en-US`);
  const data = await response.json();
  return data.results;
};
...
export const getAiringTodayTv = async (page = 1) => {
  const response = await fetch(`${BASE_URL}/tv/airing_today?api_key=${API_KEY}&page=${page}&language=en-US`);
  const data = await response.json();
  return data.results;
};
...
export const getOntheairTv = async (page = 1) => {
  const response = await fetch(`${BASE_URL}/tv/on_the_air?api_key=${API_KEY}&page=${page}&language=en-US`);
  const data = await response.json();
  return data.results;
};
...
export const getTopRatedTv = async (page = 1) => {
  const response = await fetch(`${BASE_URL}/tv/top_rated?api_key=${API_KEY}&page=${page}&language=en-US`);
  const data = await response.json();
  return data.results;
};
